module.exports = {
  ...
  meteor: {
    ...
    env: {
      ROOT_URL: 'http://staging.e-potek.ch',
      // MONGO_URL: 'mongodb://admin1:password@gcp-europe-west1-cpu.0.dblayer.com:15119/e-potek-test?ssl=true',
      MONGO_URL: 'mongodb://admin1:password@aws-eu-central-1-portal.2.dblayer.com:15723,aws-eu-central-1-portal.0.dblayer.com:15723/e-potek?ssl=true',
    },
    docker: {
