...
export const APP_ENGINES = { node: '8.15.1' };
...
export const APP_ENV_VARIABLES = {
  [ENVIRONMENT.STAGING]: {
    [APPLICATIONS.APP]: { HTTP_FORWARDED_COUNT: 1 },
    [APPLICATIONS.ADMIN]: { HTTP_FORWARDED_COUNT: 2 },
    [APPLICATIONS.WWW]: { DISABLE_WEBSOCKETS: 1, HTTP_FORWARDED_COUNT: 3 },
    [APPLICATIONS.PRO]: { HTTP_FORWARDED_COUNT: 4 },
  },
  [ENVIRONMENT.PRODUCTION]: {
    [APPLICATIONS.APP]: { HTTP_FORWARDED_COUNT: 1 },
    [APPLICATIONS.ADMIN]: { HTTP_FORWARDED_COUNT: 2 },
