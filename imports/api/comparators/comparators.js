...
export const ComparatorSchema = new SimpleSchema({
  ...
  income: { type: Number, defaultValue: 100000 },
  fortune: { type: Number, defaultValue: 100000 },
  interestRate: { type: Number, defaultValue: 0.0125 },
  borrowRatio: { type: Number, defaultValue: 0.8 },
