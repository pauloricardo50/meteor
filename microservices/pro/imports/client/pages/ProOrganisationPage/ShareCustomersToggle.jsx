  ...
  return (
    <>
      ...
      <Dialog
        ...
        text={`En activant le partage de clients, tous les utilisateurs de l'organisation ${organisationName} pourront voir les dossiers des clients que vous avez référrés.`}
        actions={[
          <Button
