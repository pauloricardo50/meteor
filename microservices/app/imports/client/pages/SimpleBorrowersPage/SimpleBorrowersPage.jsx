...
import SimpleBorrowersPageCTAs from './SimpleBorrowersPageCTAs';
...
const SimpleBorrowersPage = (props: SimpleBorrowersPageProps) => {
  const { loan, simpleForm, setSimpleForm, currentUser } = props;
    ...
    <div className="simple-borrowers-page animated fadeIn">
      ...
      >
        <div className="card1 card-top simple-borrowers-page-forms">
          <SimpleBorrowersPageHeader
            loan={loan}
            simpleForm={simpleForm}
            setSimpleForm={setSimpleForm}
          />
          {!borrowers.length ? (
            <BorrowersAdder loanId={loan._id} />
          ) : (
