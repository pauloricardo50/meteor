...
const sideNavLinks: linksType = [
  {
    id: 'DashboardPage',
    to: ROUTES.DASHBOARD_PAGE.path,
    exact: true,
    icon: faTachometer,
  },
  { id: 'FinancingPage', to: ROUTES.FINANCING_PAGE.path, icon: faChartBar },
  // { id: 'AppWidget1Page', to: ROUTES.APP_WIDGET1_PAGE, icon: faCalculator },
  { id: 'SolvencyPage', to: ROUTES.SOLVENCY_PAGE.path, icon: faScroll },
  { id: 'divider', Component: () => <Divider className="divider" /> },
  {
    id: 'RefinancingPage',
    to: ROUTES.REFINANCING_PAGE.path,
    icon: faUsdCircle,
  ...
  {
    id: 'BorrowersPage',
    to: ROUTES.BORROWERS_PAGE_NO_TAB.path,
    icon: faUsers,
    percent: loan => Calculator.personalInfoPercent({ loan }),
  },
  {
    id: 'PropertiesPage',
    to: ROUTES.PROPERTIES_PAGE.path,
    icon: faHome,
    percent: loan =>
      !loan.hasPromotion
