...
${SCRIPTPATH}/$SCRIPTS_DIR/run-backend-ci.sh --test & ${SCRIPTPATH}/$SCRIPTS_DIR/wait-port.sh $BACKEND_PORT $SERVER_E2E_CMD &  ${SCRIPTPATH}/$SCRIPTS_DIR/wait-port.sh $SERVER_PORT $TEST_E2E_CMD