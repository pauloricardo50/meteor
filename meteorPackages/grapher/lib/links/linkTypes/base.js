...
export default class Link {
  ...
  constructor(linker, object, collection) {
    this.linker = linker;
    this.object = object;
    this.linkedCollection = collection || linker.getLinkedCollection();
  ...
  find(filters = {}, options = {}, userId = undefined) {
    ...
    const appliedFilters = _.extend({}, filters, searchFilters);
  ...
  fetch(filters, options, ...others) {
    const result = this.find(filters, options, ...others).fetch();
