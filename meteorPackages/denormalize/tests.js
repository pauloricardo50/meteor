...
describe('Migration', function() {
  describe('migrate()', function() {
    it('user should not have cache before migration', function() {
      const migrant1 = Users.findOne('migrant1');
      compare(migrant1, {
        _id: 'migrant1',
        username: 'Simon',
        profile: {
    ...
    it('documents not matching selector should not have caches', function() {
      const migrant2 = Users.findOne('migrant2');
      const migrant3 = Users.findOne('migrant3');
      compare(migrant2, {
        _id: 'migrant2',
        username: 'bill_gates@microsoft.com',
        profile: {
...
describe('Type: one', function() {
  describe('Insert child', function() {
    it('child should be deeply equal except _id', function() {
      ...
      const post = Posts.findOne('post1');
      const user = Users.findOne('user1', {
  ...
  describe('Update parent referenceField', function() {
    it('cache should reflect the new child', function() {
      ...
      const post = Posts.findOne('post1');
      const user = Users.findOne('user2', {
        fields: { _id: 0, username: 1, profile: 1 },
      });
      compare(post._author, user);
    });
  ...
  describe('Insert another parent', function() {
    it('new parent should have child in cache', function() {
      ...
      const post = Posts.findOne('post2');
      const user = Users.findOne('user1', {
        fields: { _id: 0, username: 1, profile: 1 },
      });
      compare(post._author, user);
...
describe('Type: many', function() {
  describe('Insert child', function() {
    it('cache should contain child', function() {
      ...
      const post = Posts.findOne('post1');
      const image = Images.findOne('cat');
  ...
  describe('Insert another child', function() {
    it('cache should contain both children', function() {
      ...
      const post = Posts.findOne('post1');
      const cat = Images.findOne('cat');
      const dog = Images.findOne('dog');
  ...
  describe('Add child to parent referenceField', function() {
    it('cache should contain both children', function() {
      ...
      const post = Posts.findOne('post1');
      const horse = Images.findOne('horse');
      const dog = Images.findOne('dog');
  ...
  describe('Insert another parent', function() {
    it('cache should have correct children', function() {
      ...
      const post = Posts.findOne('post3');
      const dog = Images.findOne('dog');
      const horse = Images.findOne('horse');
      compare(post._images, [dog, horse]);
    });
...
describe('Type: inversed', function() {
  describe('Insert child', function() {
    it('cache should contain child', function() {
      ...
      const post = Posts.findOne('post1');
      const comment = Comments.findOne('comment1', { fields: { postId: 0 } });
  ...
  describe('Insert another child', function() {
    it('cache should contain both children', function() {
      ...
      const post = Posts.findOne('post1');
      const comment1 = Comments.findOne('comment1', { fields: { postId: 0 } });
      const comment2 = Comments.findOne('comment2', { fields: { postId: 0 } });
  ...
  describe('Update child referenceField', function() {
    it('cache should contain new and previous children', function() {
      ...
      const comment1 = Comments.findOne('comment1', { fields: { postId: 0 } });
      const comment2 = Comments.findOne('comment2', { fields: { postId: 0 } });
      const comment3 = Comments.findOne('comment3', { fields: { postId: 0 } });
  ...
  describe('Insert another parent', function() {
    it('cache should contain all children', function() {
      ...
      const post = Posts.findOne('post4');
      const comments = Comments.find({}, { fields: { postId: 0 } }).fetch();
...
describe('Type: many-inversed', function() {
  describe('Insert child', function() {
    it('parent1 should contain child', function() {
      ...
      const post1 = Posts.findOne('post1');
      const tag = Tags.findOne('tag1', { fields: { postIds: 0 } });
      compare(post1._tags, [tag]);
    });
    it('parent2 should contain child', function() {
      const post2 = Posts.findOne('post2');
      const tag = Tags.findOne('tag1', { fields: { postIds: 0 } });
      compare(post2._tags, [tag]);
    });
    it('parent3 should not contain child', function() {
      const post3 = Posts.findOne('post3');
      compare(post3._tags, []);
    });
  });
  describe('Insert another child', function() {
    it('parent1 should contain both children', function() {
      ...
      const post1 = Posts.findOne('post1');
      const tag1 = Tags.findOne('tag1', { fields: { postIds: 0 } });
      const tag2 = Tags.findOne('tag2', { fields: { postIds: 0 } });
      compare(post1._tags, [tag1, tag2]);
    });
    it('parent2 should contain both children', function() {
      const post2 = Posts.findOne('post1');
      const tag1 = Tags.findOne('tag1', { fields: { postIds: 0 } });
      const tag2 = Tags.findOne('tag2', { fields: { postIds: 0 } });
  ...
  describe('Update child referenceField', function() {
    it('parent1 should now contain the child', function() {
      ...
      const tag1 = Tags.findOne('tag1', { fields: { postIds: 0 } });
      const tag2 = Tags.findOne('tag2', { fields: { postIds: 0 } });
      const tag3 = Tags.findOne('tag3', { fields: { postIds: 0 } });
  ...
  describe('Insert another parent', function() {
    it('new parent should contain all children', function() {
      ...
      const post = Posts.findOne('post5');
      const tags = Tags.find({}, { fields: { postIds: 0 } }).fetch();
...
describe('cacheCount', function() {
  ...
  describe('Insert new parent', function() {
    it('unfiltered count should be 2', function() {
      ...
      const post = Posts.findOne('post6');
      assert.strictEqual(post._likes.all, 2);
    });
    it('filtered count should be 1', function() {
      const post = Posts.findOne('post6');
  ...
  describe('Insert document', function() {
    it('default transform field should be correct', function(done) {
      ...
      Meteor.setTimeout(function() {
        const user = Users.findOne('simon');
        try {
  ...
  describe('Type: inversed', function() {
    describe('Insert child', function() {
      it('cache should contain child', function() {
        ...
        const post = Posts.findOne('post1');
        const comment = Comments.findOne('comment1', { fields: { nested: 0 } });
    ...
    describe('Insert another child', function() {
      it('cache should contain both children', function() {
        ...
        const post = Posts.findOne('post1');
        const comment1 = Comments.findOne('comment1', {
          fields: { nested: 0 },
        });
        const comment2 = Comments.findOne('comment2', {
          fields: { nested: 0 },
        });
    ...
    describe('Update child referenceField', function() {
      it('cache should contain new and previous children', function() {
        ...
        const comment3 = Comments.findOne('comment3', {
          fields: { nested: 0 },
        });
    ...
    describe('Insert another parent', function() {
      it('cache should contain all children', function() {
        ...
        const post = Posts.findOne('post4');
        const comments = Comments.find({}, { fields: { nested: 0 } }).fetch();
  ...
  describe('Type: many-inversed', function() {
    describe('Insert child', function() {
      it('parent1 should contain child', function() {
        ...
        const post1 = Posts.findOne('post1');
        const tag = Tags.findOne('tag1', { fields: { nested: 0 } });
    ...
    describe('Insert another child', function() {
      it('parent1 should contain both children', function() {
        ...
        const post1 = Posts.findOne('post1');
        const tag1 = Tags.findOne('tag1', { fields: { nested: 0 } });
        const tag2 = Tags.findOne('tag2', { fields: { nested: 0 } });
    ...
    describe('Update child referenceField', function() {
      it('parent1 should now contain the child', function() {
        ...
        const tag1 = Tags.findOne('tag1', { fields: { nested: 0 } });
        const tag2 = Tags.findOne('tag2', { fields: { nested: 0 } });
        const tag3 = Tags.findOne('tag3', { fields: { nested: 0 } });
    ...
    describe('Insert another parent', function() {
      it('new parent should contain all children', function() {
        ...
        const post = Posts.findOne('post5');
        const tags = Tags.find({}, { fields: { nested: 0 } }).fetch();
...
describe('Recursive caching', function() {
  ...
  describe('Insert documents', function() {
    it('All caches should have correct values', function(done) {
      ...
      Meteor.setTimeout(function() {
        const customer = Customers.findOne('customer1', { fields: { _id: 0 } });
        try {
