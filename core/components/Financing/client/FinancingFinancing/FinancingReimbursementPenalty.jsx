        ...
        <div className="reimbursement-penalty-dialog">
          ...
          <div>
            {hasReimbursementPenaltyOverride ? (
              <T
                defaultMessage={
                  'Vous avez choisi des pénalités de remboursement sur mesure. Pour accéder aux pénalités de remboursement automatiques, supprimez le contenu du champ "Pénalités de remboursement"'
                }
              />
            ) : (
