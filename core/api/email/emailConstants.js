...
export const EMAIL_IDS = {
  ...
  PROMOTION_INTEREST_FORM: 'PROMOTION_INTEREST_FORM',
  PROSPECT_FOR_TOO_LONG_NOTIFICATION: 'PROSPECT_FOR_TOO_LONG_NOTIFICATION',
  NOTIFY_PRO_OF_LOST_REFERRAL: 'NOTIFY_PRO_OF_LOST_REFERRAL',
};
