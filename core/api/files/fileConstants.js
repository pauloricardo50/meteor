...
export const BORROWER_DOCUMENTS = {
  ...
  DONATION_JUSTIFICATION: 'DONATION_JUSTIFICATION',
  ...
  TAXES: 'TAXES',
  THIRD_PARTY_LOAN_JUSTIFICATION: 'THIRD_PARTY_LOAN_JUSTIFICATION',
...
export const DOCUMENTS_CATEGORIES = {
  ...
  FORTUNE_AND_OWN_FUNDS: [
    ...
    BORROWER_DOCUMENTS.THIRD_PARTY_LOAN_JUSTIFICATION,
    BORROWER_DOCUMENTS.DONATION_JUSTIFICATION,
  ],
  RETIREMENT: [
